...
# Adapted from https://github.com/sustainlab-group/SatMAE/blob/main/models_mae.py
# --------------------------------------------------------
...
from satvision_pix4d.models.utils.pos_embed import get_2d_sincos_pos_embed
...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
        ...
        self.pos_embed = nn.Parameter(
            torch.zeros(1, num_patches + 1, embed_dim), requires_grad=False)  # fixed sin-cos embedding
        ...
        self.decoder_pos_embed = nn.Parameter(
            torch.zeros(1, num_patches + 1, decoder_embed_dim), requires_grad=False)  # fixed sin-cos embedding
...
if __name__ == '__main__':
    ...
    # testing the call of he model quickly
